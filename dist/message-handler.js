...
import { setConnected, addTab, updateTab, removeTab, updateTabTools, getState, } from "./state.js";
import { getSession, getAllSessions, extractSessionIdFromCallId, } from "./session.js";
const DEFAULT_SESSION_ID = "default";
export function rejectAllSessionPendingOps(session, reason) {
...
export function handleExtensionMessage(message) {
